...
------------- | ------------- | -------------
| <td colspan=2>Statistical measures
...
pNN50 | % |NN50 count divided by the total number of all NN intervals 
| <td colspan=2>Geometric measures 
...
| ------------- | ------------- | ------------- | -------------
| <td colspan=3>Analysis of short-term recordings (5 min) 
...
LF/HF | | Ratio LF/HF |
| <td colspan=3>Analysis of entire 24 hours 
